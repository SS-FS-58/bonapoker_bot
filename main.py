...
if __name__ == '__main__':
    ...
    try:
        pytesseract.image_to_string(Image.open('pics/SN/cards/3h.png'))
    except Exception as e:
        print(e)
        print(
