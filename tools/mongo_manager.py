...
class GameLogger(object):
    ...
    def get_stacked_bar_data(self, p_name, p_value, chartType):
        ...
        self.decisions = ['Bet Bluff', 'Check Deception', 'Call Deception', 'Fold', 'Check', 'Call', 'Bet', 'Bet div 3',
        ...
        if chartType == 'stackedBar':
            FinalData = [[self.d['Bet Bluff', 'PreFlop', 'Won'], self.d['Bet Bluff', 'PreFlop', 'Lost'], 0,
                         ...
                         [self.d['Bet', 'PreFlop', 'Won'] + self.d['Bet div 3', 'PreFlop', 'Won'],
                          self.d['Bet', 'PreFlop', 'Lost'] + self.d['Bet div 3', 'PreFlop', 'Lost'], 0,
                          self.d['Bet', 'Flop', 'Won'] + self.d['Bet div 3', 'Flop', 'Won'],
                          self.d['Bet', 'Flop', 'Lost'] + self.d['Bet div 3', 'Flop', 'Lost'], 0,
                          self.d['Bet', 'Turn', 'Won'] + self.d['Bet div 3', 'Turn', 'Won'],
                          self.d['Bet', 'Turn', 'Lost'] + self.d['Bet div 3', 'Turn', 'Lost'], 0,
                          self.d['Bet', 'River', 'Won'] + self.d['Bet div 3', 'River', 'Won'],
                          self.d['Bet', 'River', 'Lost'] + self.d['Bet div 3', 'River', 'Lost']],
